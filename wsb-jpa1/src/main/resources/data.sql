...
VALUES (22, 'Connor', 'Sullivan', '123999123', 'csulivan@gmail.com', '98730', '1990-08-03', '2040-08-03', 903);

INSERT INTO PATIENT (ID, FIRST_NAME, LAST_NAME, TELEPHONE_NUMBER, EMAIL, PATIENT_NUMBER, DATE_OF_BIRTH, DATE_OF_PASSING, ADDRESS_ID)
VALUES (23, 'Sarah', 'Williams', '555234567', 'swilliams@email.com', '43215', '1985-11-15', NULL, 902);

INSERT INTO PATIENT (ID, FIRST_NAME, LAST_NAME, TELEPHONE_NUMBER, EMAIL, PATIENT_NUMBER, DATE_OF_BIRTH, DATE_OF_PASSING, ADDRESS_ID)
VALUES (24, 'Robert', 'Chen', '555345678', 'rchen@email.com', '54327', '1978-04-22', NULL, 905);
